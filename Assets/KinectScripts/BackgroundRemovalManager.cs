...
//	}
	...
	{ 
		...
		bool bKinect1Int = sensorData != null && sensorData.sensorInterface != null ?
			(sensorData.sensorInterface.GetSensorPlatform() == KinectInterop.DepthSensorPlatform.KinectSDKv2) : false;
    ...
    {
        System.IO.File.WriteAllBytes("G:/abc/" + fileName+Time.realtimeSinceStartup+".png", texture.EncodeToPNG());
    }
